...
class ViewController: UIViewController {
    ...
    let myBackstory = page(title: "My Backstory", text: "My name is Samuel Akinniranye. I was born in Nigeria, but I have been living in Indianapolis for over 10 years now. I am currently a Sophomore at Purdue University with a Computer Science degree.", image: UIImage(named: "image2.jpg")!)
    let myWeakness = page(title: "My Weakness", text: "My left hand is terrible when I hoop. My left leg is terrible when I play soccer", image: UIImage(named: "DSC_3837.jpg")!)
    let myMax = page(title: "My Max", text: "I have been very inconsistent with the gym since I got to college, but I will list my stats from 2 years ago. Squat: 405 | Bench: 275 | Clean: 235", image: UIImage(named: "image3.JPG")!)
    var pages: [page] = []
